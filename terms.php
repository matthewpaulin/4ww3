<?php $title = 'Terms | Rock Review'; ?>
<?php $currentPage = 'Rock Review'; ?>
<?php include('header.php'); ?>
<body>
 <?php include('navbar.php'); ?>
    <!-- Terms and conditions courtesy of https://www.termsandconditionsgenerator.com-->
    <main class="terms container">
        <h2 class="page-title">Terms and Conditions</h2>
        <br>
        <p>Welcome to Rock Review!</p>

        <p>These terms and conditions outline the rules and regulations for the use of Rock Review's Website, located at
            https://4ww3.matthewpaulin.com.</p>

        <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Rock Review
        ...
        <br>
        <p>We employ the use of cookies. By accessing Rock Review, you agreed to use cookies in agreement with the Rock
            Review's Privacy Policy. </p>
        ...
        <br>
        <p>Unless otherwise stated, Rock Review and/or its licensors own the intellectual property rights for all
            material on Rock Review. All intellectual property rights are reserved. You may access this from Rock Review
            for your own personal use subjected to restrictions set in these terms and conditions.</p>

        <p>You must not:</p>
        <ul>
            <li>Republish material from Rock Review</li>
            <li>Sell, rent or sub-license material from Rock Review</li>
            <li>Reproduce, duplicate or copy material from Rock Review</li>
            <li>Redistribute content from Rock Review</li>
        </ul>
        ...
        <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
            areas of the website. Rock Review does not filter, edit, publish or review Comments prior to their presence
            on the website. Comments do not reflect the views and opinions of Rock Review,its agents and/or affiliates.
            Comments reflect the views and opinions of the person who post their views and opinions. To the extent
            permitted by applicable laws, Rock Review shall not be liable for the Comments or for any liability, damages
        ...
        <p>Rock Review reserves the right to monitor all Comments and to remove any Comments which can be considered
        ...
        <p>You hereby grant Rock Review a non-exclusive license to use, reproduce, edit and authorize others to use,
        ...
        <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
            ...
            records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of Rock
            Review; and (d) the link is in the context of general resource information.</p>
        ...
        <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website,
            you must inform us by sending an e-mail to Rock Review. Please include your name, your organization name,
        ...
        <p>No use of Rock Review's logo or other artwork will be allowed for linking absent a trademark license
            agreement.</p>
        <br>
